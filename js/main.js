...
(function () {
  ...
  const LANGS = {
    en: {
      ...
      "exp-kicker":"The Experience","exp-title":"Three ways to live<br/>a day at COSTE",
    ...
    fr: {
      ...
      "exp-kicker":"L'Expérience","exp-title":"Trois façons de vivre<br/>une journée à COSTE",
    ...
    ar: {
      ...
      "exp-kicker":"التجربة","exp-title":"ثلاث طرق لعيش<br/>يوم في كوست",
